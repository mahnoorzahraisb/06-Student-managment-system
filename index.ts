...
class StudentManage {
    ...
    enroll_student(student_rollNumber: number , course: string){
    ...
    // method to view balance
    view_student_balance(student_rollNumber: number){
        let student = this.find_student(student_rollNumber)
    ...
    pay_studentFees(student_rollNumber: number, amount: number){
        let student = this.find_student(student_rollNumber)
        if(student !== undefined){
    ...
    show_studentStatus(student_rollNumber: number)
    {
        let student = this.find_student(student_rollNumber)
        if(student !== undefined){
            student.show_info()
    ...
    // method find student 
    find_student(student_rollNumber: number){
